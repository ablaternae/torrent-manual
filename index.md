...
>
>Википедия использует термин _узел_ как синоним слова _peer_, хотя на самом деле, это точка подключения, он же клиент одноранговой сети, он же одноранговый клиент. Узел более соответствует ноде (noda). Впервые фраза &laquo;peer-to-peer&raquo; была использована в 1984 году при разработке архитектуры Advanced Peer to Peer Networking ([APPN](https://ru.wikipedia.org/wiki/APPN)) фирмы IBM. 
