...
В этом документе _пир_ &mdash; это любой участник одноранговой сети (_клиент_), разделяющий загруку через BitTorrent. _Клиент_ также является _пиром_, конечно, если это BitTorrent-клиент, запущеный на локальной машине. Читатели этой спецификации могут представлять себя, как _клиента_, подключенного ко множеству _пиров_.
