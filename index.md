...
>
>Суть BitTorrent состоит обмене блоками между пирами. Когда все блоки одного фрагмента загружены, этим фрагментом можно поделиться с другими пирами. Как только все фрагменты загружены, пир меняет статус из загружающего (licher) в раздающего (seeder).
><small>из статьи [Пишем свой BitTorrent-клиент](https://tproger.ru/translations/bittorent-client-with-python/)</small>
