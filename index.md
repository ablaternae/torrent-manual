...
Начальный символ `i` и конечный `е` - начальный и конечный разделители, соответственно. Целому числу не может предшествовать префикс, состоящий из нулей, например, `i03e`. Вместе с тем, `i0e` является является корректной записью нуля.
