...
{: .warning }
Внимание! Это перевод **неофициальной** документации _первой_ версии пирингового сетевого протокола BitTórrent, запуск первой версии которого состоялся 2 июля 2001 года. 


## Определение

BitTorrent &mdash; это одноранговый протокол распространения файлов по принципу "точка-точка" (peer-to-peer), был создан Брэмом Коэном (Bram Cohen), написавшим первый torrent-клиент на языке Python 4 апреля 2001 года. Посетите его страницу по адресу http://www.bittorrent.com. BitTorrent разработан для упрощения передачи файлов на множество узлов по ненадежным сетям.
