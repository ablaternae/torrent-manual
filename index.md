...
Внимание! Это перевод _неофициальной_ документации **первой** версии пирингового сетевого протокола BitTórrent, запуск которой состоялся 2 июля 2001 года.{: .warning } 


## Определение

BitTorrent &mdash; это одноранговый протокол распространения файлов по принципу "точка-точка" (peer-to-peer), был создан Брэмом Коэном (Bram Cohen), написавшим первый torrent-клиент на языке Python 4 апреля 2001 года. Посетите его страницу по адресу [www.bittorrent.com](://www.bittorrent.com). BitTorrent разработан для упрощения передачи файлов на множество узлов по ненадежным сетям.

## Цель

Целью данной спецификации является подробное документирование спецификации протокола BitTorrent версии 1.0. Страница Брэма [спецификации протокола](://bittorrent.org/beps/bep_0003.html) описывает только основные понятия, и в некоторых моментах описанию не хватает сопутствующих деталей. Есть надежда, что этот документ, написанный в ясных и однозначных определениях, станет официальной спецификацией, которая может послужить основой для обсуждения и реализации в будущем.
...
Здесь не принимают запросы на объяснение новых особенностей. Для этого, пожалуйста, обратитесь к [почтовой рассылке](://lists.ibiblio.org/mailman/listinfo/bittorrent).
