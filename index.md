...
{: .note-title }
>примечание для тех, кто не понял
>
>Суть BitTorrent состоит обмене блоками между пирами. Когда все блоки одного фрагмента загружены, этим фрагментом можно поделиться с другими пирами. Как только все фрагменты загружены, пир меняет статус из загружающего (leecher) в раздающего (seeder).
>
